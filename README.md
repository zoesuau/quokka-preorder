...
- 手機優先的兩欄商品頁、分類與款式選擇
- 韓幣價格依後台匯率換算台幣
- 每件固定代購費（商品費用外加）與回國後預估商品款
- LINE 身分驗證、預購送單與「我的預購」
- 手機商品後台：拍照／相簿上傳、建立、編輯、上下架
- 後台設定匯率、每件代購費、LINE 社群 ID 是否必填、匯款資訊與預購說明
...
- `Products`：商品名稱、分類、圖片、韓幣價格、款式、狀態與排序。
- `Preorders`：預購人、商品明細、代購費、回國後商品款與匯款後五碼。
- `Settings`：換算率、每件代購費、LINE 社群 ID 必填設定、匯款資訊、預購說明和 iOPEN Mall 網址。
